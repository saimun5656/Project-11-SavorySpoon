  ...
  return (
    <div className='home grid md:grid-cols-4 grid-rows-4 md:grid-rows-3'>
       <div className='bg-orange-100 w-100 md:col-span-3 row-span-3 md: md:row-span-3 sec1 md:rounded-l-lg rounded-t-lg flex'>  
         ...
         <div >
           <h1 ><img className='w-96  mb-8' src="./img/Food.png" alt="" /></h1>
         ...
         <div className='hidden lg:block'>
           <img className='w-72 mb-4' src="./img/Make Vector BG.png" alt="" />
           <img className='w-72' src="./img/Make Vector BG.png" alt="" />
         </div>  
         </div>  
       </div>
       <div className='bg-green-400 w-100 sec2 md:rounded-r-lg rounded-b-lg md:rounded-bl-none md:row-span-3 relative'>
        ...
        top-10 z-10' src="./img/food-banner.png" alt="" />
        <img className='absolute md:top-32  md:right-60 md:left-0 w-36 right-44 bottom-0 z-0' src="./img/food-banner-2.png" alt=""/>
       </div>
    </div>
  );
};
